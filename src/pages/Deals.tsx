        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {t.deals.packs.map((pack, i) => {
            ...
            return (
              ...
              >
                <Card
                  className={`h-full relative ${isFeatured ? "border-accent shadow-lg ring-2 ring-accent/20" : "hover:shadow-md"} transition-shadow`}
                >
                  {isFeatured && (
                  ...
                  <CardContent className="p-8">
                    ...
                    {"example" in pack && (
                      <div className="mt-4 p-3 bg-muted/50 rounded-lg text-sm text-muted-foreground border-l-2 border-accent">
                        <p>{(pack as { example: string }).example}</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
